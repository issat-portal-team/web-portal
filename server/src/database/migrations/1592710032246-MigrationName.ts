...
export class MigrationName1592710032246 implements MigrationInterface {
    name = 'MigrationName1592710032246'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `news` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(255) NOT NULL, `link` varchar(255) NOT NULL, `source` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `img` varchar(255) NOT NULL, `publishedDate` datetime NOT NULL, `createdDateId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);

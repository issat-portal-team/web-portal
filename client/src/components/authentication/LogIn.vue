      ...
      <div class="form">
        ...
        <h2 class="title">Log In</h2>
              ...
              <div class="input-div pass">
                 ...
                 <div class="div">
                    <input placeholder="password" v-model="loginForm.password" type="password" class="input" name="password" id="password" >
                 </div>
              </div>
...
<style lang="scss">
  *{
  ...
  .btn{
    ...
    outline: none;
    border: none;
    background-image: linear-gradient(to right, #18105A, #18105A, #18105A);
    background-size: 200%;
    font-size: 1.2rem;
    color: #fff;
    font-family: 'Poppins', sans-serif;
